                    ...
                    <tbody class="table-group-divider">
                        ...
                        <tr scope="row">
                            ...
                            <td class="text-center"><button type="button" class="btn btn-outline-danger"
                                    data-bs-toggle="modal" data-bs-target="<?='#modal_baja_'. $hab['id_habitacion'] ?>"><i
                                        class="fa-solid fa-trash"></i></button></td>
                        </tr>

                        <!--Modal de dar de baja-->
                        <div class="modal fade" id="<?= 'modal_baja_'.$hab['id_habitacion']?>" tabindex="-1"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer d-flex justify-content-center align-items-center">
                                        ...
                                        <a class="btn btn-outline-danger btn-hover"
                                            href="<?= base_url('dar_baja_habitacion/'. trim($hab['id_habitacion'])) ?>">Confirmar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <tbody class="table-group-divider">
                        ...
                        <tr scope="row">
                            ...
                            <td class="text-center"><button type="button" class="btn btn-outline-success"
                                    data-bs-toggle="modal" data-bs-target="<?='#modal_alta_'.$hab['id_habitacion']?>"><i
                                        class="fa-solid fa-arrow-up-from-bracket"></i></button></td>
                        </tr>

                        <!--Modal de dar de alta-->
                        <div class="modal fade" id="<?= 'modal_alta_'.$hab['id_habitacion']?>" tabindex="-1"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer d-flex justify-content-center align-items-center">
                                        ...
                                        <a class="btn btn-outline-success btn-hover"
                                            href="<?= base_url('dar_alta_habitacion/'. trim($hab['id_habitacion'])) ?>">Confirmar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
