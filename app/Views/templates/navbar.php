...
<nav class="navbar navbar-expand-lg ">
  <div class="container-fluid mx-3">
      <a class="navbar-brand" href="<?= base_url('/') ?>">
        <img class="img-fluid" src="<?= base_url('assets/img/logo_hotel_parana.png') ?>" alt="Logo Hotel Paraná S.A." style="width:100px;">
        Hotel Paraná S.A.
      </a>
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      <ul class="navbar-nav mb-2 mb-lg-0 w-100 justify-content-end gap-2">
        ...
        <li class="nav-item btn btn-m p-0 btn-outline-light borde-btn">
          <a class="nav-link" aria-current="page" href="<?= base_url('en_construccion') ?>">Recepción</a>
        </li>
        <li class="nav-item btn btn-m p-0 btn-outline-light borde-btn">
